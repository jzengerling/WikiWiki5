...
if __name__ == '__main__':
    u = UserDatabase("cleartext")
    u.add_user("hello", "hello", True, ["test_role1", "testRole2"])
    print u.get_user("hello").data
    u.update("hello", {'active': 1, 'authentication_method': u'cleartext', 'password': u'hello', 'authenticated': 0, 'roles': [u'testRole2', u'test_role1', u'testROLE3!']} )
    print u.get_user("hello").data
    u.delete_user("hello")
    print u.get_user("hello").data